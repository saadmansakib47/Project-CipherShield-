...
public class SHA256
{
    ...
    public static byte[] Padding(string originalMessage)
    {
        ...
        // Add the bit 1 and the original message to the padded message
    ...
    public static string Hashing(byte[] paddedMessage)
    {
        ...
        {
            // Create arrays for the message schedule and temporary values
            uint[] W = new uint[64];
            ...
            for (int p = 0; p < 64; p++)
            {
                // Calculate temporary values for the compression function
            ...
            // Update the hash values with the results from this chunk
        ...
        // Concatenate the final hash values and convert to hexadecimal
    ...
    // Helper method to perform a right rotation on a 32-bit value
    ...
    // Helper methods for the sigma0, sigma1, Sigma0, and Sigma1 functions
    // Helper method for the sigma0 function
    ...
    // Helper method for the sigma1 function
